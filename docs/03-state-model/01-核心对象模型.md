...
首版 first implementation 的对象收敛、required fields 与 referential integrity 规则见 `./07-MVP-Object-Package.md`。
...
- `Lock`：由控制平面持有的 repo / module / path 锁对象
...
- `Lock` 是控制平面对象，不是 Worker 的本地自治机制。
